...
if not groq_api_key:
    raise ValueError("GROQ_API_KEY environment variable not found. Please set it in your helpers/.env file.")

if not llm_provider:
    raise ValueError("LLM_PROVIDER environment variable not found. Please set it in your helpers/.env file.")
